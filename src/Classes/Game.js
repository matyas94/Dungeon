...
export class Game{
    constructor(canvasId){
        ...
        this.boss = new Boss(this.tileSize, 24,4)
    ...
    update(){
        ...
        if (this.inputKeys["o"] && this.inputKeys["p"]){
        ...
        if (this.player.health <= 0 && !this.op){
            this.gameOver = true

        // ÚJ: Megjelenítjük a gombot, ha vége a játéknak
    ...
    window.addEventListener("keydown", (e) => {
        ...
        this.boss.update(this.player,this.sword)
